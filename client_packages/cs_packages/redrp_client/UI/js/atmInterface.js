...
function selectCard(cardNumber) {
    ...
    mp.trigger('sendSelectedCard', cardNumber);
}
...
function openMainMenu(data, hasDebt) {
    mp.trigger('debugMessage', "OPEN MAIN MENU: " + data + " " + hasDebt);
	if(data !== 'no') {
...
function makeDeposit() {
    ...
    if (amount !== '') {
        ...
        mp.trigger('makeDeposit', amount, concept);
...
function makeWithdraw() {
    ...
    if (amount !== '') {
        ...
        mp.trigger('makeWithdraw', amount, concept);
...
function makeTransfer() {
    ...
    if (account !== '' && amount !== '') {
        ...
        mp.trigger('makeTransfer', account, amount, concept);
...
function sendDepositRequest() {
	...
	mp.trigger('sendDepositRequest', depositAmount, depositConcept);
	$('#makeDepositButton').attr('disabled', 'disabled');
}
...
function sendWithdrawRequest() {
	...
	mp.trigger('sendWithdrawRequest', withdrawAmount, withdrawConcept);
	$('#makeWithdrawButton').attr('disabled', 'disabled');
}
...
function sendTransferRequest() {
	...
	mp.trigger('sendTransferRequest', transferAccount, transferAmount, transferConcept);
	$('#makeTransferButton').attr('disabled', 'disabled');
}
...
function confirmDeposit() {
    mp.trigger('confirmDeposit');
}

//Confirms the withdraw operation
function confirmWithdraw() {
    mp.trigger('confirmWithdraw');
}

//Confirms the transfer operation
function confirmTransfer() {
    mp.trigger('confirmTransfer');
}
